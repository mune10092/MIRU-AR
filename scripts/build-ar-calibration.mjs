...
const rawFile = "public/ar-calibration.raw.js";
const outFile = "public/ar-calibration.bundle.js";
const banner =
...
await esbuild.build({
  entryPoints: ["viewer/ar-calibration-main.js"],
  bundle: true,
  format: "iife",
  outfile: rawFile,
  minify: false,
...
console.log(
  `built ${outFile} (mind-ar + three@0.160, babel ios/safari 14, STEP5 calibration)`,
);
